...
PEOPLE: list[tuple[int, str, str, str, str, str, str, int, str, str, str]] = [
    ...
    (
        ...
        "华东区总经理",
        "上海",
        "销售出身;高净值客户多;微信 5w 好友",
        4,
        "产品代销",
        "吴翰林(4,合作); 何文博(4,常联系); 林海峰(3,业内); "
        "段永平(1,温州饭局); 张磊(1,高瓴 LP 大会)",
        "资源型",
    ),
    # ---- Cluster D: 政府 / 国资 ----
    (
        ...
        3,
        "政策理解;咨询费",
        "王博宇(4,圆桌会); 赵建华(4,老同事); 周景明(2,调研); 雷军(1,杭州招商接待过)",
        "关键政策节点",
    ),
    (
        13,
    ...
    (
        ...
        "创始人 / CEO",
        "深圳",
        "清华电子;芯片验证;内向;讲 PPT 一般",
        4,
        "流片资金;光电人才",
        "林海峰(4,合租室友); 苏晓明(4,前同事); 蔡嘉怡(3,创业圈); 雷军(2,小米澎湃合作过)",
        "",
    ),
    (
        16,
    ...
    (
        ...
        3,
        "博士生就业",
        "周景明(4,清华师弟); 王博宇(3,学术圈); 赵建华(3,清华校友); 冯倩(3,审过博后)",
        "",
    ),
    (
        18,
    ...
    (
        ...
        3,
        "固收产品对接",
        "周景明(3,清华校友); 赵建华(3,清华校友); 吴翰林(2,合作); 邱国鹭(3,高毅路演);",
        "",
    ),
    (
        27,
        ...
        3,
        "电商出海项目",
        "刘思敏(3,北大校友); 蔡嘉怡(3,字节前同事); 苏晓明(3,行业会); 张一鸣(2,字节前同事)",
        "",
    ),
    (
        28,
    ...
    (
        ...
        "主管合伙人",
        "上海",
        "TMT 早期投资人; 风格高调; 滴滴/小红书早期投资; 媒体活跃",
        0,
        "新风口 deal flow",
        "",
        "想接触 · 圈内可引荐",
...
def build() -> Path:
    ...
    for row_i, p in enumerate(PEOPLE, start=1):
        (idx, name, industry, company, role, city, feats, trust, needs, peers, notes) = p
