...
{
  "ranking": [
    {"id": "P012", "role": "本人", "score": 0.95, "reason": "..."},
    {"id": "P003", "role": "桥梁", "score": 0.7,  "reason": "..."},
    ...
  ]
}
```
...
* ``reason`` 用一句中文，写明判定依据（来自 bio 的事实，不要瞎编）；
...
class LLMJudgeReranker:
    ...
    def _parse_verdicts(
        ...
        for entry in ranking:
            ...
            out[pid] = _JudgeVerdict(role=role, score=score, reason=reason)
        return out
